...
| File | Changes |
|------|---------|
| `crates/chainspec/src/hardfork.rs` | Added T1 hardfork, `t1_active()` method, updated `is_t0()` |
...
| `test_t1_active_false_for_t0` | `T0.t1_active() == false` |
| `test_t1_active_true_for_t1` | `T1.t1_active() == true` |
...
| `test_aa_tx_gas_multiple_sstores` | **783,069** | 2 SSTOREs to new slots (2×250k) + new account (250k) |
