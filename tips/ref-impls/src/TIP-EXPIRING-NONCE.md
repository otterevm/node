...
- **Spec ID**: TIP-XXX (Expiring Nonces)
- **Authors/Owners**: Tempo Team
- **Status**: Draft
- **Related Specs**: TIP-20, Tempo Transaction Spec, 2D Nonce Spec
