---
title: State Creation Cost Specification
description: Technical specification for increased gas costs protecting Tempo from state growth attacks, including account creation and contract deployment costs.
---

# State Creation Cost Specification

See [TIP-1000](/protocol/tips/tip-1000) for the full proposal, motivation, and implementation details.
