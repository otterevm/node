...
/// If multiple storage providers are instantiated in parallel threads,
...
///
/// `thread_local::StorageAccessor` mirrors these methods with split mutability for read vs write.
