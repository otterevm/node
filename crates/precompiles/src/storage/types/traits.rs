...
pub trait StorageType: Sized {
    ...
    /// # Errors
    ///
    /// Returns `PrecompileError::Fatal` if the value cannot be decoded.
    fn from_u256(value: U256) -> Result<Self, PrecompileError>;
...
impl StorageType for String {
    fn from_u256(value: U256) -> Result<Self, PrecompileError> {
        ...
        Self::from_utf8(utf8_bytes.to_vec())
            .map_err(|e| PrecompileError::Fatal(format!("Invalid UTF-8 in stored string: {e}")))
    }
