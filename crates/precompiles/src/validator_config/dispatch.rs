...
mod tests {
    use super::*;
    use crate::{
        expect_precompile_revert, test_precompile,
        test_util::{assert_full_coverage, check_selector_coverage},
    };
    use alloy::{primitives::FixedBytes, sol_types::SolValue};
    ...
    test_precompile!(owner_view_dispatch, |sender, owner| {
        let mut validator_config = ValidatorConfig::new();
    ...
    test_precompile!(add_validator_dispatch, |owner, validator_addr| {
        let mut validator_config = ValidatorConfig::new();
    ...
    test_precompile!(
        unauthorized_add_validator_dispatch,
        |owner, non_owner, validator_addr| {
            let mut validator_config = ValidatorConfig::new();
